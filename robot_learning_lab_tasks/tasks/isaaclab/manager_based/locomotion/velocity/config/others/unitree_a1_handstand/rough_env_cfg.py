...
from robot_learning_lab_tasks.tasks.isaaclab.manager_based.locomotion.velocity.velocity_env_cfg import LocomotionVelocityRoughEnvCfg, RewardsCfg
...
# use local assets
from robot_learning_lab_zoo.assets.isaaclab.unitree import UNITREE_A1_CFG  # isort: skip
