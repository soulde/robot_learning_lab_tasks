...
##
# use local assets
from robot_learning_lab_zoo.assets.isaaclab.deeprobotics import DEEPROBOTICS_DR02_STANDARD_CFG  # isort: skip


@configclass
class DeeproboticsDR02StandardRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    base_link_name = "base_link"
    foot_link_name = ".*_ankle_x_link"
    ...
    def __post_init__(self):
        ...
        self.rewards.create_joint_deviation_l1_rewterm("joint_deviation_hip_l1", -0.1, [".*hip_[xz].*"])
        ...
        if self.__class__.__name__ == "DeeproboticsDR02StandardRoughEnvCfg":
