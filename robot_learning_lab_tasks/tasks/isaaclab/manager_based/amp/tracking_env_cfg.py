...
import robot_learning_lab_tasks.tasks.isaaclab.manager_based.beyondmimic.mdp as mdp
...
class ObservationsCfg:
    ...
    class DiscriminatorCfg(ObsGroup):
        """AMP discriminator observations.

        This group contains the observations used by the AMP discriminator.
        The discriminator learns to distinguish between expert (reference motion)
        and policy trajectories.

        AMP observation contains:
        - joint_pos: Joint positions
        - joint_vel: Joint velocities
        - body_pos_relative: Key body positions relative to root
        - base_lin_vel: Base linear velocity
        - base_ang_vel: Base angular velocity
        - base_height: Base height in world frame
        """
...
class AMPEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the AMP motion imitation environment."""
