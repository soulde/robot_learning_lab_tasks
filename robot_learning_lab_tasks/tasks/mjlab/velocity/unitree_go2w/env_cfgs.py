...
from robot_learning_lab_zoo.assets.mjlab.unitree_wheeled import (
    LEG_JOINT_NAMES, UNITREE_GO2W_CFG, WHEEL_BODY_NAMES, WHEEL_GEOM_NAMES,
    WHEEL_JOINT_NAMES, WHEEL_SITE_NAMES,
)

from robot_learning_lab_tasks.tasks.mjlab.velocity import observations, rewards

LEG_JOINTS = LEG_JOINT_NAMES
WHEEL_JOINTS = WHEEL_JOINT_NAMES
ALL_JOINTS = LEG_JOINTS + WHEEL_JOINTS
WHEEL_SITES = WHEEL_SITE_NAMES
WHEEL_GEOMS = WHEEL_GEOM_NAMES


def unitree_go2w_actions_cfg():
...
def unitree_go2w_rough_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
    ...
    cfg.scene.entities = {"robot": deepcopy(UNITREE_GO2W_CFG)}
    ...
    cfg.actions = unitree_go2w_actions_cfg()
    ...
    cfg.rewards = unitree_go2w_rewards_cfg()
