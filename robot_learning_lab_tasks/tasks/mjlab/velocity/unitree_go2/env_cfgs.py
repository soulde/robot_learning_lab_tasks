...
from robot_learning_lab_zoo.assets.mjlab.unitree_go2 import (
    UNITREE_GO2_ACTION_SCALE, UNITREE_GO2_CFG, UNITREE_GO2_FOOT_BODY_NAMES,
    UNITREE_GO2_FOOT_GEOM_NAMES, UNITREE_GO2_FOOT_SITE_NAMES, UNITREE_GO2_JOINT_NAMES,
)

from robot_learning_lab_tasks.tasks.mjlab.velocity import rewards

BASE_BODY = "base"
FOOT_BODIES = UNITREE_GO2_FOOT_BODY_NAMES
FOOT_SITES = UNITREE_GO2_FOOT_SITE_NAMES
FOOT_GEOMS = UNITREE_GO2_FOOT_GEOM_NAMES


def unitree_go2_actions_cfg():
    return {"joint_pos": JointPositionActionCfg(entity_name="robot", actuator_names=UNITREE_GO2_JOINT_NAMES,
        scale=UNITREE_GO2_ACTION_SCALE,
        clip={".*": (-100.0, 100.0)}, use_default_offset=True, preserve_order=True)}


def unitree_go2_rewards_cfg():
    return {
        ...
        "stand_still": RewardTermCfg(func=rewards.stand_still, weight=-2.0,
            params={"command_name": "twist", "asset_cfg": SceneEntityCfg("robot", joint_names=UNITREE_GO2_JOINT_NAMES)}),
        ...
        "joint_mirror": RewardTermCfg(func=rewards.joint_mirror, weight=-0.05,
            params={"asset_cfg": SceneEntityCfg("robot", joint_names=UNITREE_GO2_JOINT_NAMES),
...
def unitree_go2_rough_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
    ...
    cfg.scene.entities = {"robot": deepcopy(UNITREE_GO2_CFG)}
    ...
    cfg.rewards = unitree_go2_rewards_cfg()
    ...
    cfg.actions = unitree_go2_actions_cfg()
...
def unitree_go2_flat_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
    cfg = unitree_go2_rough_env_cfg(play=play); assert cfg.scene.terrain is not None
