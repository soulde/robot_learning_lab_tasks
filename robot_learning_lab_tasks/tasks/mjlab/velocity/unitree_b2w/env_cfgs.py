...
from robot_learning_lab_zoo.assets.mjlab.unitree_wheeled import (
    LEG_JOINT_NAMES, UNITREE_B2W_CFG, WHEEL_BODY_NAMES, WHEEL_GEOM_NAMES,
...
def unitree_b2w_rough_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
    ...
    cfg.scene.entities = {"robot": deepcopy(UNITREE_B2W_CFG)}
